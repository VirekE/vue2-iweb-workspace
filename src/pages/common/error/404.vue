...
<template>
    <div class="wscn-http404-container">
        <div class="wscn-http404">
            <div class="pic-404">
                <img src="../../../images/404.png" alt="404" class="pic-404__parent">
                <img :src="cloudBase64" alt="404" class="pic-404__child left">
                <img :src="cloudBase64" alt="404" class="pic-404__child mid">
                <img :src="cloudBase64" alt="404" class="pic-404__child right">
            </div>
            <div class="bullshit">
                ...
                <a href="javascript:void(0)" @click="onHome" class="bullshit__return-home router-link-active">
                    返回首页
                </a>
            </div>
        </div>
...
.wscn-http404 .bullshit__info,.wscn-http404 .bullshit__return-home {
	opacity: 0;
	-webkit-animation-name: slideUp;
	animation-name: slideUp;
	-webkit-animation-duration: .5s;
