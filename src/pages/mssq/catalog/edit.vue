<template>
	...
	<div class="material" ref="tableH">
		<div>
			...
			<div class="tab-box">
				<el-table :data="catalogList" v-loading="loading" style="width: 100%;" height="100%"  class="qz-table-hide">
					...
					<el-table-column label="事项层级" prop="level" width="160"
...
<!--          </el-table-column>-->
					<el-table-column label="状态" prop="status" align="center" :formatter="formatterState" width="150">
					...
					<el-table-column label="操作" width="160" fixed="right">
						<template slot-scope="scope">
							...
							<!--只有发布状态才有创建事项和变更-->
							<el-button type="text"
								v-if="scope.row.version>= 1&& (scope.row.status !== 'APPROVAL_WAIT' && scope.row.status !== 'EXAMINE_WAIT')"
								@click="editMinor(scope.row.id,scope.row.catalogId)">变更
							</el-button>
						</template>
					</el-table-column>
				</el-table>
