...
<template>
  <div class="baseInfo">
    <h3 class="title"><p class="content">{{type === 'item'?'实施信息':'办理项实施信息'}}</p>
      <el-button v-if="type == 'statistical'" type="text" @click="ssxxData" :disabled="flag">
        <i class="iconfont icon-morenzhitianchong"></i>数据填充
      </el-button>
    </h3>
    <el-form :model="itemInfoData" :disabled="flag" label-width="170px" ref="formName" :rules="rules">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="办理部门名称" prop="applyDeptName">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.applyDeptName" disabled
          ...
          <el-col :span="12">
            <el-form-item label="主办内（下）设机构" :prop="itemInfoData.isStreet == '0'?'applyAgentName':'empty'">
              ...
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.applyAgentName"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="实施类型" prop="taskType">
              ...
              <el-select :class="flag?'inputDisabled':''" v-model="itemInfoData.taskType">
          ...
          <el-col :span="12">
            <el-form-item label="事项类型" prop="matterType">
              ...
              <el-select :class="flag?'inputDisabled':''" v-model="itemInfoData.matterType">
        ...
        <el-row v-if="itemInfoData.taskType !== '1'">
          <el-col :span="24">
            <el-form-item label="协办部门" prop="assistDept">
              ...
              <el-input :class="flag?'inputDisabled':''" readonly v-model="itemInfoData.assistDept"
                        placeholder="请选择协办部门">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="实施对象" class="select"
              ...
              <!--<el-select :class="flag?'inputDisabled':''" v-model="itemInfoData.taskObject">
          ...
          <el-col :span="12">
            <el-form-item label="实施频率" class="select"
              ...
              <el-select :class="flag?'inputDisabled':''" v-model="itemInfoData.promiseFrequency">
                <el-option label="定期" value="1"></el-option>
                <el-option label="不定期" value="2"></el-option>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="实施频率说明" class="timeDay">
              ...
              <el-col :span="12">
                <el-form-item>
                  <!-- <el-select :class="flag?'inputDisabled':''" v-model="itemInfoData.promiseHz">
                     <el-option v-for="(item,index) in $store.getters.getDict['CZPLCS']" :key="index" :label="item.itemValue"
                                :value="item.itemCode"></el-option>
                   </el-select>-->
                  <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.promiseHz"
                            placeholder="请输入实施频率"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="margin-left:10px;width: calc(50% - 10px)">
                <el-form-item>
                  <el-select :class="flag?'inputDisabled':''" v-model="itemInfoData.promiseHzUnit">
        ...
        <el-row v-if="type == 'statistical'">
          <el-col :span="24">
            <el-form-item label="办理项说明">
              ...
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.description" rows="3"
        ...
        <el-row v-else>
          <el-col :span="24">
            <el-form-item label="事项说明" prop="itemExplain">
              ...
              <el-input :class="flag?'inputDisabled':''" placeholder="请输入事项说明" v-model="itemInfoData.itemExplain"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="职责说明" prop="dutyExplain">
              ...
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.dutyExplain" type="textarea" :rows="5"
        ...
        <el-row v-if="type == 'item'">
          <el-col :span="24">
            <el-form-item label="受理标准" prop="acceptCondition">
              ...
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.acceptCondition" type="textarea"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="处置流程" prop="promiseProcess.promiseProcessNote">
              ...
              <el-input :class="flag?'inputDisabled':''" placeholder="请输入处置流程"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="处置流程图" prop="promiseProcess.promiseProcesst">
              ...
              <el-upload :disabled="flag" class="upload" ref="material"
                         ...
                         :on-error="modelError"
                         :file-list="itemInfoData.promiseProcess&&itemInfoData.promiseProcess.promiseProcesst">
        ...
        <el-row v-if="type == 'item'">
          <el-col :span="24">
            <el-form-item label="办结标准" prop="applyCondition">
              ...
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.applyCondition" type="textarea" :rows="5"
                        placeholder="(一)办结标准。
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="考核要求">
              ...
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.checkRequire" type="textarea" :rows="5"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="备注">
              <el-input :class="flag?'inputDisabled':''" v-model="itemInfoData.remark" type="textarea" :rows="5"
