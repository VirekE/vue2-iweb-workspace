...
<template>
  <div class="baseInfo">
    ...
    <el-form :model="itemInfoData" :disabled="flag" label-width="170px" :rules="rules" ref="itemInfoData">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="事项名称" prop="itemName">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.itemName" disabled placeholder="请输入事项名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="事项编码" prop="itemCode">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.itemCode" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="一级索引名称" prop="primaryIndexName">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.primaryIndexName" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="一级索引码" prop="primaryIndex">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.primaryIndex" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="二级索引名称" prop="parentName">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.parentName" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="二级索引码" prop="parentCode">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.parentCode" disabled></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="三级索引码" prop="catalogCode">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.catalogCode" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="实施部门名称" prop="selfDeptName">
              ...
              <el-input class="inputDisabled" v-model="itemInfoData.selfDeptName" disabled placeholder=""></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="事项层级" prop="level">
              ...
              <el-select class="inputDisabled" v-model="itemInfoData.level" disabled>
          ...
          <el-col :span="12">
            <el-form-item label="管理类型" prop="manageType">
              ...
              <el-select class="inputDisabled" v-model="itemInfoData.manageType" disabled placeholder="请选择管理类型">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="设立依据" prop="catalogLaw">
              ...
              <el-input type="textarea" :readonly="!!itemInfoData.proCode" :class="flag?'inputDisabled':''" :rows="3" v-model="itemInfoData.catalogLaw" placeholder="请输入设立依据"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </div>
